...
import code_llama  # Replace openai_codex with code_llama
import datetime
...
class VulnerabilityScanner:
    ...
    def _load_model(self, model_path: str) -> None:
        ...
        """
        model_data = code_llama.load(model_path)  # Replace openai_codex.load with code_llama.load
    ...
    def save_model(self, model_path: str) -> None:
        ...
        code_llama.dump(model_data, model_path)  # Replace openai_codex.dump with code_llama.dump
...
def interactive_mode():
    ...
    while True:
        ...
        print("2. Run demo scan with test vulnerabilities")
        print("3. Exit")
